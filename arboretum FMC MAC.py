...
measured_fmc = measured_fmc_file1 + measured_fmc_file2 + measured_fmc_file3 + measured_fmc_file4 + measured_fmc_file5
...
plt.scatter(measured_fmc*4, ozfuel_band1_spectra + ozfuel_band2_spectra + ozfuel_band3_spectra + ozfuel_band4_spectra) 

slope, intercept, r_value, p_value, std_err = stats.linregress(measured_fmc*4, ozfuel_band1_spectra + ozfuel_band2_spectra + ozfuel_band3_spectra + ozfuel_band4_spectra)
xvals = range(int(min(measured_fmc)), int(max(measured_fmc)))

plt.plot(xvals, slope*xvals + intercept, 'r')
plt.title('Simulated spectra from imagery vs measured fuel moisture content of $\it{Corymbia}$ $\it{maculata}$')
