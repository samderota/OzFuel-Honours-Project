...
file1 = "C:/Users/Sam/Google Drive/UNI/2022/ENGN4350/Python/Tidbinbilla/Reorder_288_4111_384_U16.bin"                 #tidbindilla roads and trees
...
rawdata = np.reshape(rawdata, (len(wavelengths), length, height))  #correct order 
data = np.rot90(rawdata, 1, (1,2))

# file2 = "imgs/data output.txt"
...
#nested list containing each band, note - only contains SWIR bands. full list in archive.py
base_bands = list(np.arange(900,2400,1))
...
himawari_dims = [1, int(length/himawari_scaling)]                               #causes issues because floor of 0.xx is 0
...
for wave in base_bands:     #generate a base image in the 900-2500nm range
    base_hyper.append(bisect.bisect_left(wavelengths, wave))                #bisect gives an approximate as SWIR data bands aren't awfully close together
...
plt.figure(dpi=1200)
plt.imshow(ozfuel_imgs[0])
plt.figure(dpi=1200)
plt.imshow(ozfuel_imgs[1])
plt.figure(dpi=1200)
plt.imshow(ozfuel_imgs[2])
plt.figure(dpi=1200)
plt.imshow(ozfuel_imgs[3])
plt.imsave('imgs/ozfuel/sim_ozfuel_band_1.png', ozfuel_imgs[0])
plt.imsave('imgs/ozfuel/sim_ozfuel_band_2.png', ozfuel_imgs[1])
plt.imsave('imgs/ozfuel/sim_ozfuel_band_3.png', ozfuel_imgs[2])
plt.imsave('imgs/ozfuel/sim_ozfuel_band_4.png', ozfuel_imgs[3])
...
plt.figure(dpi=1200)
plt.imshow(modis_imgs[0])
plt.imsave('imgs/modis/sim_modis_band_5.png', modis_imgs[0])
plt.figure(dpi=1200)
plt.imshow(modis_imgs[1])
plt.imsave('imgs/modis/sim_modis_band_6.png', modis_imgs[1])
plt.figure(dpi=1200)
plt.imshow(modis_imgs[2])
plt.imsave('imgs/modis/sim_modis_band_7.png', modis_imgs[2])
...
plt.figure(dpi=1200)
plt.imshow(sentinel_imgs[0])
plt.imsave('imgs/sentinel/sim_sentinel_band_10.png', sentinel_imgs[0])
plt.figure(dpi=1200)
plt.imshow(sentinel_imgs[1])
plt.imsave('imgs/sentinel/sim_sentinel_band_12.png', sentinel_imgs[1])
...
plt.figure(dpi=1200)
plt.imshow(landsat_imgs[0])
plt.imsave('imgs/landsat/sim_landsat_band_6.png', landsat_imgs[0])
plt.figure(dpi=1200)
plt.imshow(landsat_imgs[1])
plt.imsave('imgs/landsat/sim_landsat_band_7.png', landsat_imgs[1])
...
plt.imsave('imgs/himawari/sim_himawari_band_5.png', himawari_imgs[0], vmin=0.0, vmax=1.0)
plt.figure(dpi=1200)
plt.imshow(himawari_imgs[1], vmin=0.0, vmax=1.0)
plt.imsave('imgs/himawari/sim_himawari_band_6.png', himawari_imgs[1], vmin=0.0, vmax=1.0)
...
plt.savefig('imgs/himawari/hist_himawari_band_5.png')
