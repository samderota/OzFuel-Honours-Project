...
file1 = "C:/Users/Sam/Google Drive/UNI/2022/ENGN4350/Python/Reorder_288_2430_384_U16.bin"       #arboretum
...
ozfuel_dims = [1,1]#[int(height/ozfuel_scaling), int(length/ozfuel_scaling)]
modis_dims = [1,1]#[int(height/modis_scaling), int(length/modis_scaling)]
sentinel_dims = [int(height/sentinel_scaling), int(length/sentinel_scaling)]
landsat_dims = [1,1]#[int(height/landsat_scaling), int(length/landsat_scaling)]
...
plt.figure(dpi=1200)    
plt.imshow(img)
plt.savefig('imgs/swir/sum.png', bbox_inches='tight')
