...
(measured_tri_fmc_file1+measured_tri_fmc_file2+measured_tri_fmc_file3, ozfuel_band1_spectra)
...
measured_tri_fmc = measured_tri_fmc_file1 + measured_tri_fmc_file2 + measured_tri_fmc_file3 + measured_tri_fmc_file4 + measured_tri_fmc_file5
all_points = ozfuel_band1_spectra + ozfuel_band2_spectra + ozfuel_band3_spectra + ozfuel_band4_spectra
num_points = len(all_points)

fig = plt.figure(dpi=600, figsize=(12,8))
plt.scatter(measured_tri_fmc*4, ozfuel_band1_spectra + ozfuel_band2_spectra + ozfuel_band3_spectra + ozfuel_band4_spectra) 

slope, intercept, r_value, p_value, std_err = stats.linregress(measured_tri_fmc*4, ozfuel_band1_spectra + ozfuel_band2_spectra + ozfuel_band3_spectra + ozfuel_band4_spectra)
xvals = range(int(min(measured_tri_fmc)), int(max(measured_tri_fmc)))

plt.plot(xvals, slope*xvals + intercept, 'r')
plt.title('Simulated spectra from imagery vs measured fuel moisture content of $\it{Eucalptus}$ $\it{tricarpa}$')
...
plt.savefig('fmc/TRI_fmc.png', bbox_inches='tight')
